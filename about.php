...
<body>
    ...
    Šifrovacia hra je totiž hlavne o zážitkoch z hry samotnej.
    </p><p>
    ...
    Ale nebojte sa, nenecháme vás umrznúť v lese :-) Máme pre vás pripravený systém nápovied, keby ste mali s niečím problém.
    </p>
    ...
    Šifra nie je kvízová otázka, ktorú buď viete alebo neviete zodpovedať. Šifru na prvý pohľad <em>neviete</em> vyriešiť. Zároveň zväčša na jej riešenie časom prídete. Každá šifra je originálna. Treba sa zamyslieť ako na ňu.
Nie je problém vymyslieť neriešiteľnú šifru. Tu je: <kbd>fwuagughrkjs</kbd>. My však chceme, aby šifra bola riešiteľná a aby ste mali z nej zážitok. Budete mať zážitok z prvočíselného rozkladu obrovských čísiel? Asi nie. To je práca pre počítače. Takú šifru vám nedáme.
    </p>
    
    <p>
    <blockquote class="blockquote-reverse">
    Dobrá šifra je jednoznačná a keď ju vyriešite viete, že ste ju vyriešili správne.</blockquote>
    Predstavte si, že na stanovisku vám dáme do rúk šifru - bagetu. Máte ísť do pekárne? Alebo do obchodu?
    Naozaj si myslíte, že rok vymýšľame šifrovačku kvôli tomu, aby ste náhodne obiehali blízke prevádzky? Možno áno, ale predtým, než sa vyberieme na pochod sa skúsme ešte ďalej zamyslieť.
    Dobrá šifra je jednoznačná a keď ju vyriešite viete, že ste ju vyriešili správne. Asi ste si zatiaľ niečo na tej bagete nevšimli.
    </p> 
    
    <p>
    <blockquote class="blockquote"> Asi to nebude náhoda. Každý detail môže byť dôležitý.</blockquote>
    Keby bola bageta napríklad zabalená do francúzskej vlajky a existovala by pekáreň na Francúzskej ulici, tak by to vyzeralo nádejne. To už asi nebude náhoda. Pravdepodobne nebudeme baliť bagetu do vlajky, ak by tá vlajka nebola potrebná k riešeniu. Každý detail môže byť dôležitý.
    Ale keďže vy ste dostali len bagetu, treba sa radšej zamyslieť. Čo všetko ste dostali? Čo je zadanie?
    </p>
    
     <p>
    <blockquote class="blockquote-reverse">Pýtajte sa prečo.</blockquote>
    Následne musíte šifru analyzovať a pýtať sa prečo. Analýza je najdôležitejšia časť.
    Dostanem farebný obrázok, ale očividne chýba na ňom modrá farba. Prečo? Mám kopu čísiel, ale všetky sú párne. Prečo?
    Prečo každá veta začína iným písmenom? Prečo sú všetky uhly pravé? Prečo ste si mali zobrať na šiforvačku zápalky?
    ...
    Môžete ju odvážiť a premerať - pravdepdobne nič zvláštne nezistíte. Môžete ju ochutnať. A vtedy zistíte, že je plnená.
    Vnútri sú nejaké zapečené guličky z cesta.
    Tak ich predsa vyberte! Dávajte pozor, čo robíte. Ich poradie môže byť dôležité.
    Ak nejakú stratíte alebo zjete, tak šifru asi ľahko nevyriešite... No dobre, máte zoradené/očíslované pečené guličky. Čo s nimi?
    Áno, asi opäť ochutnať. Tá prvá chutí ako hrach? Fuj. Druhá... egreš? Tretia slivky? Štvrtá citrón. Piata oregano.
    ...
    Ahá, to nebude citrón, ale limetka! Je fajn si po sebe veci kontrolovať.
    </p>
  <div class="col-md-offset-4"><a class="example-image-link" href="img/milka.JPG" data-lightbox="example-1"><img class="img-thumbnail" src="img/milka_thumb.jpg" alt="image-1" /></a></div>
    ...
    <p>
    V skutočnej šifre by vám vyšlo namiesto slova <kbd>HESLO</kbd> napríklad <kbd>HODZOVONAMFONTANA</kbd>. Hodžovo námestie, šifra bude pri fontáne. Hurá, môžete ísť :)
    ...
    <p>
    Ak chcete potrénovať a pripraviť sa na hru, môžete si pozrieť napríklad šifry z minulého ročníka alebo stránky skvelej letnej Bratislavskej šifrovačky <a href="http://sifrovacka.sk/" target="_blank">Brieždenie</a>.
