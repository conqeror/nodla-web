    ...
    <h1>Dôležité informácie a pravidlá</h1>
        ...
        <div class="col-md-9">
          <div class="tab-content">
            ...
            <div class="tab-pane" id="rules"><h2>Pravidlá</h2>
            ...
            <div class="tab-pane" id="points"><h2>Bodovanie a nápovedy</h2>
            ...
            <div class="tab-pane" id="bring"><h2>Čo si doniesť</h2>
                <ul>
...
<h2>Prihlasovanie a platba štartovného</h2>
		...
		<!--<p>
		<font color="red"></font>
		Prihlasovanie je možné po konzultácii s organizátormi. Prípadne môžete napísať, ak zháňate tím.
		</p>
		-->
		<p><b>Hry sa zúčastňujete na vlastnú zodpovednosť. Minimálny vek je preto 18 rokov.</b></p>
...
>>>>>>> f2987b82c5d6efa6d61dd7feb4559b2ad1951279
    </div>
